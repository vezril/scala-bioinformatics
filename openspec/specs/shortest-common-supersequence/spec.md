...
Compute a shortest common supersequence of two DNA strings — the shortest string that contains both inputs as subsequences. It has length |s| + |t| − LCS(s,t) and is built by interleaving the two strings around their longest common subsequence (Rosalind SCSP).
