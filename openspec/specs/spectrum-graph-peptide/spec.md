...
Infer the longest protein matching the spectrum graph of a mass list `L` — the edge-label string of a longest path in the DAG whose edges connect masses differing by an amino-acid residue mass (Rosalind SGRA).
