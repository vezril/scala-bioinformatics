...
Validates a DNA contig collection and computes its N-statistics (N50 and N75) — the
maximum length L such that contigs of length at least L account for at least the target
percentage of the total assembled length.
