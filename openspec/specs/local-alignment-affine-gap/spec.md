# local-alignment-affine-gap Specification

## Purpose

Compute the maximum local alignment score of two protein strings under the
BLOSUM62 substitution matrix with an affine gap penalty, returning the score and
one optimal pair of aligned substrings.
