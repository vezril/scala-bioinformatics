# newick-parsing Specification

## Purpose

Parses Newick-format tree strings into a structured `NewickTree` ADT
(Rosalind problem 30 — NWCK, "Distances in Trees"). Handles labelled and
unlabelled internal nodes, nested groups, and the terminating semicolon;
