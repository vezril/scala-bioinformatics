...
Generate every unrooted binary tree on a collection of n taxa (Rosalind EUBT), rendered in Newick format. Trees are produced via incremental edge insertion, yielding the full (2n−5)!! distinct trees rooted at the first taxon.
