...
Provide the capability to compute B(n) = (2n−3)!! mod 1,000,000, the number of distinct rooted binary trees on `n` labeled taxa (Rosalind ROOT). This is the rooted counterpart of CUNR, exposing a validated leaf-count domain type and a counting algorithm reduced modulo 1,000,000.
