## Purpose
Define the pure function that computes the reverse complement of a `DnaString` — reversing the base sequence and replacing each base with its Watson-Crick complement (A↔T, C↔G). This is Rosalind problem REVC.
